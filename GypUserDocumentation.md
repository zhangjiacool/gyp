...
The possible entries in a library target are largely the same
...
The Chromium `.gyp` files all have appropriate `conditions` entries
...
Add a dictionary defining the new executable target
